...
# 
from fairseq.models.transformer.transformer_base2 import (
...
class TransformerS2Model(TransformerModelBase2):
    """
    This is the legacy implementation of the transformer model that
    uses argparse for configuration.
    """
    ...
    def __init__(self, args, encoder, decoder, bertencoder, berttokenizer):
        cfg = TransformerConfig.from_namespace(args)
        super().__init__(cfg, encoder, decoder, bertencoder, berttokenizer)
        self.args = args
