...
class TransformerDecoderBase2(FairseqIncrementalDecoder):
    """
    ...
    def extract_features_scriptable(
        ...
        bert_enc: Optional[Tensor] = None
        bert_encoder_padding_mask: Optional[Tensor] = None
        if bert_encoder_out is not None and len(bert_encoder_out["bert_encoder_out"]) > 0:
            bert_enc = bert_encoder_out["bert_encoder_out"][0]
        if bert_encoder_out is not None and len(bert_encoder_out["encoder_padding_mask"]) > 0:
            bert_encoder_padding_mask = bert_encoder_padding_mask["bert_encoder_padding_mask"][0]
...
class TransformerDecoder2(TransformerDecoderBase2):
    def __init__(
        self,
        args,
        dictionary,
